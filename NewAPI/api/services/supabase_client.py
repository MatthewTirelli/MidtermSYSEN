...
# Single-request range for windowed observations (avoid pagination loops for typical 1-hour window)
...
def fetch_observations_window(start_iso: str, end_iso: str) -> list[dict[str, Any]]:
    ...
    No full-table scan; single request with range for the filtered result.
    """
    base = _base_url()
